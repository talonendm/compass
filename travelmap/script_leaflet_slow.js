...
const mapboxSatellite = L.tileLayer(
  ...
  } // NOTE: replace with your own Mapbox token - this works only in talonen.github.io deployments
);

const HaquesArchitect = L.tileLayer(
  'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}',
  {
    id: 'haques/cjn2uavha0wh52ro8dov791ry',
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'nope', 
    attribution: '© Mapbox © OpenStreetMap'
...
const baseMaps = {
 "OpenStreetMap": osm,
  ...
  "HaquesArchitect": HaquesArchitect
};
